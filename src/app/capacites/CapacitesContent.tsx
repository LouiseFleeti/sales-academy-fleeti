    ...
    <div className="relative min-h-[calc(100vh-56px)]" style={{ background: "#f8f9fb" }}>
      <div className="px-10 py-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1 max-w-xl">Les briques fonctionnelles du produit Fleeti — ce que la plateforme sait techniquement faire, à utiliser pour appuyer les arguments solutions.</p>
          <p className="text-xs text-gray-400 mt-1">{items.length} capacités</p>
        </div>
            ...
            <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between z-10">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <nav className="flex items-center gap-1.5 text-xs text-gray-400 min-w-0 truncate">
                  <button onClick={closePanel} className="shrink-0 hover:text-gray-700 transition-colors">Capacités produit</button>
